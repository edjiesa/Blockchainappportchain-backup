                ...
                <tr key={tx.blockchain_tx_id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-sm text-gray-900">{tx.tx_id.substring(0, 16)}...</span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">{tx.function_name}</td>
                  <td className="px-6 py-4 font-mono text-sm text-gray-600">{tx.channel_name}</td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
